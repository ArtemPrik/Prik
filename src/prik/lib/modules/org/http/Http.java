package prik.lib.modules.org.http;
...
public class Http implements Module {
    ...
    public void init() {
        ...
        map.set("urlencode", new http_urlencode());
        map.set("http", new http_http());
        map.set("download", new http_download());
        Variables.define("Http", map);
    }
