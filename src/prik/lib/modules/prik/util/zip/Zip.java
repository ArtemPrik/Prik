package prik.lib.modules.prik.util.zip;
 ...
 * @author Professional
 */
public final class Zip implements Module {
    @Override
    public void init() {
        MapValue map = new MapValue(5);
        
        map.set("zip", this::zipWithMapper);
        map.set("zipFiles", this::zipFiles);
        map.set("unzip", this::unzip);
        map.set("unzipFiles", this::unzipFiles);
        map.set("listZipEntries", this::listZipEntries);
        
        Variables.define("Zip", map);
    }
