package prik.lib.modules.prik.awt;
 ...
 * @author Professional
 */
public final class Robot implements prik.lib.modules.Module {
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(prik.lib.modules.prik.awt.Robot.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (isRobotInitialized) {
            map.set("click", convertFunction(prik.lib.modules.prik.awt.Robot::click));
